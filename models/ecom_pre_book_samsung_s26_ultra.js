...
const SamsungS26Ultra = new mongoose.Schema(
  {
    name: { 
      type: String, 
      required: true, 
...
export default  mongoose.models.ecom_prebook_samsung_s26_ultra || mongoose.model("ecom_prebook_samsung_s26_ultra", SamsungS26Ultra);

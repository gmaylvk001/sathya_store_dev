...
/** Shared accept list for all category page builder image inputs. */
export const CATEGORY_PAGE_IMAGE_ACCEPT = "image/*";

export const CATEGORY_PAGE_IMAGE_ACCEPT_HINT =
  "Any image format. Files are saved as uploaded (no format conversion).";

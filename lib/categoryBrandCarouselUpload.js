 ...
 * HEIC/HEIF is auto-converted to JPG. JPG/PNG/WebP/GIF/AVIF saved as-is.
 */
export async function saveCategoryBrandCarouselImage(file) {
  ...
  if (kind === "jpg" || kind === "png" || kind === "webp" || kind === "gif" || kind === "avif") {
    ...
    return {
      path: `/uploads/category-brand-carousel/${filename}`,
      width,
      height,
    };
  }
  ...
  try {
    ...
    console.error("Brand carousel upload failed:", err);
    throw new Error(
